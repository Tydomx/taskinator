...
var createTaskEl = function(taskDataObj) {
    ...
    // add task id as custom attribute when task item gets created
    listItemEl.setAttribute("data-task-id", taskIdCounter);

    // create div to hold task info and add to list item
    var taskInfoEl = document.createElement("div");
    taskInfoEl.className = "task-info";
    // add HTML content to div, allowed name/type input to still be the same
...
var createTaskActions = function(taskId) {
    ...
    deleteButtonEl.className = "task-actions";
...
var loadTasks = function() {
    ...
    // console.log(tasks);
    // iterates thru a tasks array & creates task elements on the page from it 
    for (var i=0;i<tasks.length;i++) {
        ...
        // appending taskInfoEl into listItemEl <li><div><h3></h3></div></li>
        listItemEl.appendChild(taskInfoEl);
